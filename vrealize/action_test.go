...
func TestGetResourceScalingActionLinks(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()

	actionLinks, err := client.getResourceScalingActionLinks("937099db-5174-4862-99a3-9c2666bfca28")

	if len(actionLinks) != 0 {
		t.Errorf("function should not return action links")
	}
	if err == nil {
		t.Errorf("error expected while readin resource action links")
	}
	...
	actionLinks2, err2 := client.getResourceScalingActionLinks("937099db-5174-4862-99a3-9c2666bfca28")

	if len(actionLinks2) == 0 {
		t.Errorf("action links not returned by function")
	}
	if err2 != nil {
		t.Errorf("unexpected error found while fetchin resource scaling action links")
	}

}


func TestGetDeploymentScalingTemplates(t *testing.T) {

	link1 := "http://localhost/catalog-service/api/consumer/resources/b313acd6-0738-439c-b601-e3ebf9ebb49b/actions/85e090f9-9529-4101-9691-6bab1b0a1f77/requests/template"
	link2 := "http://localhost/catalog-service/api/consumer/resources/b313acd6-0738-439c-b601-e3ebf9ebb49b/actions/ab5795f5-32ad-4f6c-8598-1d3a7d190caa/requests/template"

	template1, template2, err := client.getDeploymentScalingTemplates(link1, link2)

	if template1 != nil || template2 != nil {
		t.Errorf("empty templates was expected while fetching deployment scaling templates")
	}

	if err == nil {
		t.Errorf("error was expected while fetching deployment scaling templates")
	}
	...
	httpmock.RegisterResponder("GET", link1,
		httpmock.NewStringResponder(200, `{"type":"com.vmware.vcac.catalog.domain.request.CatalogResourceRequest","resourceId":"b313acd6-0738-439c-b601-e3ebf9ebb49b","actionId":"85e090f9-9529-4101-9691-6bab1b0a1f77","description":null,"data":{"CentOS_6.3":{"componentTypeId":"com.vmware.csp.component.cafe.composition","componentId":null,"classId":"Blueprint.Component.Declaration","typeFilter":"CentOS63*CentOS_6.3","data":{"_cluster":2}}}}`))
	...
	httpmock.RegisterResponder("GET", link2,
		httpmock.NewStringResponder(200, `{"type":"com.vmware.vcac.catalog.domain.request.CatalogResourceRequest","resourceId":"b313acd6-0738-439c-b601-e3ebf9ebb49b","actionId":"ab5795f5-32ad-4f6c-8598-1d3a7d190caa","description":null,"data":{"CentOS_6.3":{"componentTypeId":"com.vmware.csp.component.cafe.composition","componentId":null,"classId":"Blueprint.Component.Declaration","typeFilter":"CentOS63*CentOS_6.3","data":{"_cluster":2}}}}`))

	template1, template2, err = client.getDeploymentScalingTemplates(link1, link2)

	if template1 == nil || template2 == nil {
		t.Errorf("empty templates was not expected while fetching deployment scaling templates")
	}

	if err != nil {
		t.Errorf("empty error was expected while fetching deployment scaling templates")
	}
